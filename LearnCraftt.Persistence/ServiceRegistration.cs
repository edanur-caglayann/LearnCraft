...
namespace LearnCraftt.Persistence
{
    ...
    public static class ServiceRegistration
    {
        ...
        {
            services.AddDbContext<LearnCrafttDbContext>(opt => opt.UseNpgsql(configuration.GetConnectionString("DefaultConnection")));
        ...
        // UploadedContent
        services.AddScoped<IUploadedContentWriteRepository, UploadedContentWriteRepository>();
        services.AddScoped<IUploadedContentReadRepository, UploadedContentReadRepository>();
